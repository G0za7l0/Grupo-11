...
using ETLService.Security.Adapters;
...
namespace ETLService.Security
{
    public class AuthNetCore
    {
        ...
        public static object ClearSeason(string? sessionKey)
        {
        ...
        public static object Login(UserModel inst, string? sessionKey)
        {
            ...
            var userEntity =  UserModelBuilder.build(user);           // Generar una nueva sessionKey simple para el ejemplo
